...
lcd.setCursor(7,0);lcd.print(L" MIN");lcd.setCursor(11,0);lcd.print(minimym);lcd.setCursor(7,1);lcd.print(L" MAX");lcd.setCursor(11,1);lcd.print(maximym);
...
if(regim==1){lcd.setCursor(13,0);lcd.print(L" AB");}else{lcd.setCursor(13,0);lcd.print(L" РЧ");}
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void menu(){
    ...
    while(millis()-currentMillis<=loopTime)
     {
      ...
      delay(100);
      if (analogRead(keyDown) < 100 ) { stoped=stoped-1;currentMillis = millis();if (stoped<=9){lcd.setCursor(5, 1); lcd.print(L" ");}if (stoped<=0){stoped=0;} } 
      if (analogRead(keyUp)   < 100 ) { stoped=stoped+1;currentMillis = millis();if (stoped>=32){stoped=32;} }
      if (analogRead(keySelect)< 100) { currentMillis = 0;}
     }
    ...
    while(millis()-currentMillis<=loopTime)
     {
      ...
      delay(100);
      if (analogRead(keyDown) < 100 ) { ran=ran-1;currentMillis = millis();if (ran<=0){ran=0;} } 
      if (analogRead(keyUp)   < 100 ) { ran=ran+1;currentMillis = millis();if (ran>=32){ran=32;} }
      if (analogRead(keySelect)< 100) { currentMillis = 0;}
